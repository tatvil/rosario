    <?php
        function misterios ($nombreMisterio)
            {
                switch ($nombreMisterio)
                    {
                        ...
                        case "gloriosos":
                            ...
                            break;
                        case "dolorosos":
                            $titulo=array('La oracion en el Huerto','La Flagelación','La coronación de espinas','Jesús con la cruz a cuestas hasta el calvario','La Crucifixión');
                            var_dump ($titulo);
                            break;
                        case "gozosos":
                            $titulo=array('La anunciación', 'La Visita','El Nacimiento del hijo de Dios','La presentación en el Templo','El niño Jesus perdido y hallado en el templo');
                            var_dump ($titulo);
