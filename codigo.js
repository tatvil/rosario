  ...
  function misteriosLuminosos (dia)
    {
      ...
      textoMisterio3.textContent = 'El anuncio del Reino de Dios invitando a la conversión (Regni Dei proclamatio coniuncta cum invitamento ad conversionem)</p><blockquote>«El tiempo se ha cumplido y el Reino de Dios está cerca; convertíos y creed en el Evangelio». (Mc 1, 15) «Todos los hombres están llamados a entrar en el Reino. Anunciado en primer lugar a los hijos de Israel, este reino mesiánico está destinado a acoger a los hombres de todas las naciones» (CIC, 543).'
   
      tituloMisterio4.textContent = '4º misterio. La Transfiguración';
      textoMisterio4.textContent = 'La Transfiguración de Cristo en el Monte Tabor (Transfiguratio)</p><blockquote>«Seis días después, Jesús tomó consigo a Pedro, a Santiago y a su hermano Juan, y los llevó aparte, a un monte alto. Y se transfiguró delante de ellos: su rostro se puso brillante como el sol y sus vestidos se volvieron blancos como la luz» (Mt 17, 1-2).«Por un instante, Jesús muestra su gloria divina, confirmando así la confesión de Pedro. Muestra también que para "entrar en su gloria" (Lc 24, 26), es necesario pasar por la Cruz en Jerusalén» (CIC, 555).';
