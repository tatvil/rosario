...
var nombreMisterio = "";
var diaSemana = "";
var tituloMisterio=new Array(5);
var textoMisterio=new Array(5);
...
function visualizarCabecera(misterio,dia)
  {
    nombreMisterio.textContent ="MISTERIOS "+misterio;
  }
...
function inicializarVariables ()
  {
    ...
    tituloMisterio	= document.getElementById('tituloMisterio');
    textoMisterio	= document.getElementById('textoMisterio');

    imagen = document.getElementById("imagen");
    bAtras = document.getElementById("boton1");
    bAlante = document.getElementById("boton2");
...
function misteriosGloriosos(dia)
    {
        ...
        tituloMisterio[1].textContent = '1º misterio. La Resurreccion de Jesucristo';
        imagen[0].src = 'imagenes/gloriosos/1.jpg';
        ...
        imagen[1].src = 'imagenes/gloriosos/2.jpg';
        ...
        imagen[2].src = 'imagenes/gloriosos/3.jpg';
        ...
        imagen[3].src = 'imagenes/gloriosos/4.jpg';
        ...
        imagen[4].src = 'imagenes/gloriosos/5.jpg';
  ...
  function misteriosDolorosos (dia)
  {
      ...
      imagen1.src = 'imagenes/dolorosos/1.jpg';
      ...
      imagen2.src = 'imagenes/dolorosos/2.jpg';
      ...
      imagen3.src = 'imagenes/dolorosos/3.jpg';
      ...
      imagen4.src = 'imagenes/dolorosos/4.jpg';
      ...
      imagen5.src = 'imagenes/dolorosos/5.jpg';
  ...
  function misteriosLuminosos (dia)
    {
      ...
      imagen1.src = 'imagenes/luminosos/1.jpg';
      ...
      imagen2.src = 'imagenes/luminosos/2.jpg';
      ...
      imagen3.src = 'imagenes/luminosos/3.jpg';
      ...
      imagen4.src = 'imagenes/luminosos/4.jpg';
      ...
      imagen5.src = 'imagenes/luminosos/5.jpg';
  ...
  function misteriosGozosos (dia)  // Lunes y sabados
    {
      ...
      imagen1.src = 'imagenes/gozosos/1.jpg';
      ...
      imagen2.src = 'imagenes/gozosos/2.jpg';
      ...
      imagen3.src = 'imagenes/gozosos/3.jpg';
      ...
      imagen4.src = 'imagenes/gozosos/4.jpg';
      ...
      imagen5.src = 'imagenes/gozosos/5.jpg';
...
function visualizarMisterios(dia)
  {
    ...
    switch (dia)
          {
            case 0:
              visualizarCabecera('gloriosos','domingo');
              directorioImagenes="imagenes/gloriosos/";
              domingo.classList.add("active");
              break;
            case 1:
              visualizarCabecera('gozosos','lunes');
              directorioImagenes="imagenes/gozosos/";
              lunes.classList.add("active");
              break;
            case 2:
              visualizarCabecera('dolorosos','martes');
              directorioImagenes="imagenes/dolorosos/";
              martes.classList.add("active");
              break;
            case 3:
              visualizarCabecera('gloriosos','miercoles');
              directorioImagenes="imagenes/gloriosos/";
              miercoles.classList.add("active");
              break;
            case 4:              
              visualizarCabecera('luminosos','jueves');
              directorioImagenes="imagenes/luminosos/";
              jueves.classList.add("active");
              break;
            case 5:              
              visualizarCabecera('dolorosos','viernes');
              directorioImagenes="imagenes/dolorosos/";
              viernes.classList.add("active");
              break;
            case 6:
              visualizarCabecera('gozosos','sabado');
              directorioImagenes="imagenes/gozosos/";
...
function setListeners()
    ...
    bAtras.addEventListener("click",retroceder);
    bAlante.addEventListener("click",avanzar);
...
//    intervalId = setInterval(avanzar,tiempo);
