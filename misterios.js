...
weekday[0] = "GLORIOSOS";   //Domingo
weekday[1] = "GOZOSOS";     //Lunes
weekday[2] = "DOLOROSOS";   //Martes
weekday[3] = "GLORIOSOS";   //Miercoles
weekday[4] = "LUMINOSOS";   //Jueves
weekday[5] = "DOLOROSOS";   //Viernes
weekday[6] = "GOZOSOS";     //Sabado

var n = weekday[d.getDay()];
document.write("<H3>MISTERIOS "+ n+"</H3>");

    document.write('<hr>');
    for (i=0;i<5;i++ ){
        document.write ('<h4>GLORIA</h4>');
        document.write ('<p>Gloria al Padre y al Hijo y al Espíritu Santo. Como era en el principio, ahora y siempre, por los siglos de los siglos AMEN</p>');
        document.write ('<h4>INVOCACIÓN</h4>');
        document.write ('<p>María, Madre de gracia, Madre de misericordia, defiéndenos de nuestros enemigos y ampáranos ahora y en la hora de nuestra muerte. AMEN</p>');
        document.write ('<p>OH Jesús mío, perdónanos, libranos del fuego del infierno, lleva al Cielo a todas las almas, especialmente las más necesitadas.</p>');
        switch (d.getDay())
          {
            case 0 :
                    document.write ('<h4>' + misteriosGloriosos[i].numero + ' misterio. ' + misteriosGloriosos[i].titulo + '</h4>');
                    document.write (misteriosGloriosos[i].texto);
                    break;
            case 1:
                    document.write ('<h4>'+ misteriosGozosos[i].numero + ' misterio. ' + misteriosGozosos[i].titulo + '</h4>');
                    document.write (misteriosGozosos[i].texto);
                    break;
            case 2:
                    document.write ('<h4>' + misteriosDolorosos[i].numero + ' misterio. ' + misteriosDolorosos[i].titulo + '</h4>');
                    document.write (misteriosDolorosos[i].texto);
                    break;
            case 3 :
                    document.write ('<h4>' + misteriosGloriosos[i].numero + ' misterio. ' + misteriosGloriosos[i].titulo + '</h4>');
                    document.write (misteriosGloriosos[i].texto);
                    break;
            case 4:
                    document.write ('<h4>' + misteriosLuminosos[i].numero + ' misterio. ' + misteriosLuminosos[i].titulo + '</h4>');
                    document.write (misteriosLuminosos[i].texto);
                    break;
            case 5:
                    document.write ('<h4>' + misteriosDolorosos[i].numero + ' misterio. ' + misteriosDolorosos[i].titulo + '</h4>');
                    document.write (misteriosDolorosos[i].texto);
        ...
        document.write('<h4>PADRE NUESTRO</h4>');
        document.write('<p>Padre nuestro, que estas en el cielo, santificado sea tu nombre, venga a nosotros tu reino, hágase tu voluntad, en la tierra como en el cielo. </p><p>Danos hoy nuestro pan de cada día, perdona nuestras ofensas, como también nosotros perdonamos a los que nos ofenden. No nos dejes caer en la tentación, y libranos del mal. AMEN');
        document.write('<hr>');
        document.write('<h4>AVE MARIA x10</h4>');
        document.write('<p>Dios te salve, María, llena eres de gracia, el Señor es contigo. Bendita tu eres entre todas las mujeres y bendito es el fruto del tu vientre, Jesús. </p><p>Santa María, Madre de Dios, ruega por nosotros pecadores, ahora y en la hora de nuestra muerte. AMEN </p>');
        document.write('<hr>');
    };